...
#define FFMPEG_CONFIGURATION "--disable-everything --enable-demuxer=mov --enable-ffplay --enable-protocol=file --enable-avformat --enable-avcodec --enable-decoder=rawvideo --enable-decoder=aac --enable-debug=3 --enable-decoder=h264 --disable-network --disable-zlib --disable-yasm --disable-avfilter --disable-avdevice"
